...
def update_camera_vision_database(
    ...
    black_color_str = str([0.0, 0.0, 0.0])

    # --- Update the Tray record ---
    tray_data = {
        "object_name": "tray",
        "object_color": "black",  # default color name
        "color_code": black_color_str,  # black in normalized RGB
        "pos_x": tray_vector[0],
        "pos_y": tray_vector[1],
        "pos_z": tray_vector[2],
        "rot_x": 0.0,
    ...
    holder_data = {
        "object_name": "holder",
        "object_color": "black",
        "color_code": black_color_str,  # default color for holder
    ...
    for index, detection in enumerate(slide_detections, start=1):
        ...
        slide_data = {
            ...
            "color_code": str(slide_color_code),
            "pos_x": slide_pos_x,
            "pos_y": slide_pos_y,
            "pos_z": slide_pos_z,
            "rot_x": 0.0,
