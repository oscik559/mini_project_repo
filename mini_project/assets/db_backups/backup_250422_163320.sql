...
26083	slide_1	green	{0,0,0}	46	145	-21	0	0	0	Slide.usd	2025-04-22 16:33:17.846414
26084	slide_2	pink	{0,0,0}	46	206	-21	0	0	0	Slide.usd	2025-04-22 16:33:17.848245
26085	Fixture	black	{0,0,0}	5.78	15.74	0	180	0	-5.61	Fixture.usd	2025-04-22 16:33:17.849638
26086	Slide_Holder	white	{0,0,0}	18	44	8	180	0	0	Slide_Holder.usd	2025-04-22 16:33:17.850702
\.
...
1	2025-04-22 11:10:27.760719	1	voice	en	command	f	Pick up object	\N	0.95
2	2025-04-22 11:10:27.760719	2	text	en	command	f	Place object	\N	0.9
\.
...
1	1	1	task_query	{"task": "Pick Object"}	2023-10-01 09:00:00	2023-10-01 17:00:00	2025-04-22 11:10:27.760719
2	2	1	preference_update	{"preference": {"time": "morning"}}	2023-10-01 09:00:00	2023-10-01 17:00:00	2025-04-22 11:10:27.760719
3	1	2	task_execution	{"status": "success", "task": "Place Object"}	2023-10-02 09:00:00	2023-10-02 17:00:00	2025-04-22 11:10:27.760719
\.
...
2	shape_stacking	pick, travel, drop	Stack blocks of shapes based on their type and color	{stack,shape,pile}	detect_shapes_pgSQL.py	t	f	idle	2025-04-22 11:20:44.17163
1	slide_sorting	pick, travel, drop	Sort slides by shape and color into trays	{sort,slide,sorting,arrange}	detect_slides_pgSQL.py	t	t	triggered	2025-04-22 11:21:10.052605
\.
...
11	1	1	pick	slide_2	2	f	2025-04-22 12:04:23.012267
12	2	2	travel	slide_2	2	f	2025-04-22 12:04:23.012267
13	3	3	drop	slide_2	2	f	2025-04-22 12:04:23.012267
14	4	1	pick	slide_1	2	f	2025-04-22 12:04:23.012267
15	5	2	travel	slide_1	2	f	2025-04-22 12:04:23.012267
16	6	3	drop	slide_1	2	f	2025-04-22 12:04:23.012267
17	7	6	go_home		2	f	2025-04-22 12:04:23.012267
\.
...
4	1	slide_2	t	y	0.01	t
5	2	slide_1	t	y	0.01	t
\.
...
1	1	t	{"accuracy": 0.95, "time_taken": 2.5}	No errors	2025-04-22 11:10:27.760719
2	2	f	{"accuracy": 0.8, "time_taken": 3.0}	Gripper misalignment	2025-04-22 11:10:27.760719
\.
...
5	2	slide_1	0.085	y-axis	t
4	1	slide_2	0.085	y-axis	t
\.
...
1	session_voice_001	2025-04-22 11:26:50.012327	oscik559	Sort the slides in order of green, pink and green.		Sort the slides in order of green, pink and green.	0.95	t
2	session_voice_001	2025-04-22 12:04:22.948015	oscik559	Sort the slides in order of pink and green.		Sort the slides in order of pink and green.	0.95	t
\.
...
1	1a081993-9586-48b2-a1e5-35c3f6dcff01	Sort the slides in order of green, pink and green.	\N	english	f	2025-04-22 11:26:49.95036
2	28a40046-bc3d-42c0-ab70-6fced7964ec7	Sort the slides in order of pink and green.	\N	english	f	2025-04-22 12:04:22.880993
\.
...
SELECT pg_catalog.setval('public.camera_vision_object_id_seq', 26086, true);
...
SELECT pg_catalog.setval('public.drop_op_parameters_sequence_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.operation_sequence_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.pick_op_parameters_sequence_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.sort_order_order_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.travel_op_parameters_sequence_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.unified_instructions_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.voice_instructions_id_seq', 2, true);
