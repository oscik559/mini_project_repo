...
class DatabaseHandler:
    ...
    def validate_table_schema(self, table_name: str, expected_columns: List[Tuple[str, str]]) -> None:
            """
            ...
            for column_name, column_def in expected_columns:
                if column_name not in existing_columns:
                    try:
                        ...
                        logging.info(f"Schema update failed for {table_name}.{column_name}: {str(e)}")
    ...
    def clear_tables(self):
        ...
        try:
            with self.conn:
                self.cursor.execute("PRAGMA foreign_keys = OFF;")  # Temporarily disable foreign key constraints

                # Delete dependent tables first
                dependent_tables = [
                    "interaction_memory", "task_preferences", "instructions",
                    "instruction_operation_sequence", "simulation_results"
                ]
                ...
                parent_tables = [
                    "users", "sequence_library", "states", "operation_sequence",
                    "screw_op_parameters", "camera_vision", "sort_order", "skills"
                ]
    ...
    def populate_interaction_memory(self):
        interactions = [
            (1, 1, "task_query", '{"task": "Pick Object"}', '2023-10-01 09:00:00', '2023-10-01 17:00:00'),
            (2, 1, "preference_update", '{"preference": {"time": "morning"}}', '2023-10-01 09:00:00', '2023-10-01 17:00:00'),
            (1, 2, "task_execution", '{"status": "success", "task": "Place Object"}', '2023-10-02 09:00:00', '2023-10-02 17:00:00')
        ]
        self.cursor.executemany(
    ...
    def populate_skills(self):
        skills = [
            ("pick", "Pick up object", '{"gripper_force": 0.5}', '{"gripper": true}', 2.5),
