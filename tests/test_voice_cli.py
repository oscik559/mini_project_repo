...
import argparse
from mini_project.modalities.voice_processor_pgSQL import VoiceProcessor, Transcriber, AudioRecorder, SpeechSynthesizer
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", choices=["capture", "transcribe", "record", "tts"], required=True, help="Component to test")
