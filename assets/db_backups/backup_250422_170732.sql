...
1	2025-04-22 16:36:40.71755	1	voice	en	command	f	Pick up object	\N	0.95
2	2025-04-22 16:36:40.71755	2	text	en	command	f	Place object	\N	0.9
\.
...
1	1	1	task_query	{"task": "Pick Object"}	2023-10-01 09:00:00	2023-10-01 17:00:00	2025-04-22 16:36:40.71755
2	2	1	preference_update	{"preference": {"time": "morning"}}	2023-10-01 09:00:00	2023-10-01 17:00:00	2025-04-22 16:36:40.71755
3	1	2	task_execution	{"status": "success", "task": "Place Object"}	2023-10-02 09:00:00	2023-10-02 17:00:00	2025-04-22 16:36:40.71755
\.
...
2	shape_stacking	pick, travel, drop	Stack blocks of shapes based on their type and color	{stack,shape,pile}	detect_shapes_pgSQL.py	t	f	idle	\N
1	slide_sorting	pick, travel, drop	Sort slides by shape and color into trays	{sort,slide,sorting,arrange}	detect_slides_pgSQL.py	t	t	triggered	2025-04-22 16:38:06.378826
\.
...
1	1	1	pick	slide_2	1	f	2025-04-22 16:38:36.016412
2	2	2	travel	slide_2	1	f	2025-04-22 16:38:36.016412
3	3	3	drop	slide_2	1	f	2025-04-22 16:38:36.016412
4	4	1	pick	slide_1	1	f	2025-04-22 16:38:36.016412
5	5	2	travel	slide_1	1	f	2025-04-22 16:38:36.016412
6	6	3	drop	slide_1	1	f	2025-04-22 16:38:36.016412
7	7	6	go_home		1	f	2025-04-22 16:38:36.016412
\.
...
2	2	slide_1	t	y	0.01	t
1	1	slide_2	t	y	0.01	t
\.
...
1	1	t	{"accuracy": 0.95, "time_taken": 2.5}	No errors	2025-04-22 16:36:40.71755
2	2	f	{"accuracy": 0.8, "time_taken": 3.0}	Gripper misalignment	2025-04-22 16:36:40.71755
\.
...
2	2	slide_1	0.085	y-axis	t
1	1	slide_2	0.085	y-axis	t
\.
...
1	session_voice_001	2025-04-22 16:38:35.95217	oscik559	sort the slides in order of pink and green		sort the slides in order of pink and green	0.95	t
\.
...
1	7bf576a7-61a4-4fdd-bc18-afb93aec9b96	sort the slides in order of pink and green	\N	english	f	2025-04-22 16:38:35.889093
\.
...
SELECT pg_catalog.setval('public.camera_vision_object_id_seq', 424, true);
...
SELECT pg_catalog.setval('public.operation_sequence_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.pick_op_parameters_sequence_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.travel_op_parameters_sequence_id_seq', 2, true);
