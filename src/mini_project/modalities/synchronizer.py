...
#     # Partition records into voice and gesture lists based on available keys.
#     voice_records = []
#     gesture_records = []

#     for cmd in session_commands:
#         # Assume voice instructions have 'transcribed_text'
#         if "transcribed_text" in cmd and cmd["transcribed_text"]:
#             voice_records.append(cmd)
#         # Assume gesture instructions have 'gesture_text'
#         if "gesture_text" in cmd and cmd["gesture_text"]:
#             gesture_records.append(cmd)
...
#     # Merge the texts using a delimiter.
#     merged_voice = DELIMITER.join(record["transcribed_text"] for record in voice_records).strip()
#     merged_gesture = DELIMITER.join(record["gesture_text"] for record in gesture_records).strip()
