...
VOICE_PROCESSING_CONFIG = {
    "recording": {
        "temp_audio_path": str(TEMP_AUDIO_PATH / "recording.wav"),  # Path to save recorded audio
        "sampling_rate": 16000,  # Audio sample rate (Hz)
        "max_duration": 60,  # Maximum recording duration (seconds)
        "initial_silence_duration": 10,  # Silence allowed before speech starts (seconds)
        "post_speech_silence_duration": 5,  # Silence allowed after speech ends (seconds)
